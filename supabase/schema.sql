...
-- ========================================================
-- إضافات متعلقة برفع الصور (Avatar & Company Logo)
-- ========================================================
...
on storage.objects for insert 
with check (bucket_id = 'company-logos' and (select company_id from public.profiles where id = auth.uid()) IS NOT NULL);
